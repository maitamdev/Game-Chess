...
ALTER TABLE "game_rooms" ADD CONSTRAINT "ck_game_rooms_type" CHECK ("game_rooms"."game_type" in ('chess', 'xiangqi', 'caro', 'jungle', 'oanquan', 'uno', 'tienlen'));--> statement-breakpoint
ALTER TABLE "game_rooms" ADD CONSTRAINT "ck_game_rooms_shape" CHECK ((
        ...
        or
        ("game_rooms"."game_type" not in ('uno', 'tienlen') and "game_rooms"."max_players" = 2 and "game_rooms"."time_control" is not null)
      ));