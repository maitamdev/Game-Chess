...
const data: GuideData = {
  ...
  uiTips: [
    ...
    "Mỗi thú hiển thị bằng emoji kèm số cấp ở góc; hai ô của nước vừa đi được tô màu đồng.",
    ...
    "Thú bị bắt hiện thành dãy emoji trên thẻ người chơi; âm thanh bật/tắt bằng nút ♪; sau ván có thể đóng hộp kết quả để ngắm lại bàn cờ.",
  ],
  notation:
  ...
  modes: [
    {
      href: "/jungle/online",
      label: "Đấu online",
      note: "Cần đăng nhập — Elo cờ thú riêng",
    },
    {
