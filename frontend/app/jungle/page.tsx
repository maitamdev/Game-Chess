...
const modes = [
  {
    ...
    title: "Đấu online",
    glyph: "🦁",
    description: "Ghép cặp theo Elo cờ thú riêng. Đồng hồ phía máy chủ, xếp hạng.",
    note: "Cần đăng nhập",
  },
  {
    ...
    title: "Đấu với máy",
    glyph: "🐯",
    description: "AI nhìn trước nhiều nước với 5 mức độ, chạy trong trình duyệt.",
  ...
  },
  {
    ...
    glyph: "🐘",
    description: "Thay phiên nhau trên cùng thiết bị, bàn tự xoay về phía người đang đi.",
    note: "Không cần mạng",
  },
];
    ...
    <div className="mx-auto max-w-6xl px-4 py-12">
      <div className="mb-12 max-w-2xl">
        ...
        <p className="mt-3 text-base text-muted">
          Voi sợ Chuột, Chuột bơi sông, Sư tử và Hổ nhảy phắt qua bờ — đưa một
          con thú vào hang đối phương là thắng.
        </p>
        <Link
          href="/jungle/guide"
