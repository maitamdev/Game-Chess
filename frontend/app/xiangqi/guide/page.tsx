...
const data: GuideData = {
  ...
  uiTips: [
    ...
    "Quân bị ăn hiện bằng chữ Hán trên thẻ người chơi; kết thúc ván có hộp kết quả kèm lý do và thay đổi Elo cờ tướng (online).",
  ],
  notation:
  ...
  modes: [
    {
      href: "/xiangqi/online",
      label: "Đấu online",
      note: "Cần đăng nhập — Elo cờ tướng riêng",
    },
    {
